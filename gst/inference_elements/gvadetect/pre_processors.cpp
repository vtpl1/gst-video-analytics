...
bool IsROIDetectionNeeded(GvaBaseInference *gva_base_inference, guint current_num_frame, GstBuffer * /* *buffer*/,
                               GstVideoRegionOfInterestMeta *roi) {
    UNUSED(current_num_frame);
...
GetROIPreProcFunction INPUT_PRE_PROCESS_DETECTION = NULL;
IsROIDetectionNeededFunction IS_ROI_DETECTION_NEEDED = IsROIDetectionNeeded;
